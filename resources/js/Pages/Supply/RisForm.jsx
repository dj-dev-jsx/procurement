      ...
      >
        ...
        <div className="bg-white p-6 rounded-xl shadow-md">
            ...
            <p className="text-sm text-gray-600 mb-6">
                <strong>Note:</strong> This item is categorized as <em>Consumable</em> and will be issued using a RIS form.
            </p>
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        className={`w-full mt-1 px-3 py-2 border rounded-md shadow-sm ${
                            isInStock ? "border-green-400 bg-green-50" : "border-red-400 bg-red-50"
                        }`}
                        />
                    </div>
                    </div>
